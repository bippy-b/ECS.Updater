...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Me.Label1.Text = "ProClaim America Application  Updater"
...
#End Region
    ...
    Private Sub Form1_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        If NeedToCopy = True Then
            ...
            pbDownload.Value = 50
            Me.Refresh()
            UpdateFiles(DownloadTo & "ServerManifest.xml", DownloadFrom, DownloadTo)
        Else
    ...
    Function UpdateFiles(ByVal server_filename As String, ByVal FromDir As String, ByVal ToDir As String)
        ...
        Catch e As Exception
            MessageBox.Show("An error has occured while updating the clientmanifest.xml file.  Please let David know.", "Oops!", MessageBoxButtons.OK)
